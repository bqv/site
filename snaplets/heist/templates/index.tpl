...
<html lang="en">
  ...
  <head>
    ...
    <title>Tony Olagbaiye | Home</title>

    <meta name="description" content="Tony Olagbaiye - Software Engineer, Mathematician, Linguist">
    <meta name="keywords" content="tony, olagbaiye, software, engineer, developer, programming">
    <meta name="author" content="Tony Olagbaiye">
            ...
            <div class="padding-50 flex-panel">
              <div class="row row-no-padding">
                <div class="col-md-12 nopadding">
                  <h3 class="font-accident-two-normal uppercase title">WIP Site HTML</h3>
                  <div class="quote">
                    <h4 class="font-accident-two-normal uppercase subtitle">Perfect for CV / Site or Portfolio Website</h4>
                ...
                <div class="col-md-4 infoblock nopadding">
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-11 col-md-9">
                      ...
                      <p class="">
                        The WIP Site has an unique modern flat intuitive design. You can choose one of 8 Color schemes.
                      </p>
                    </div>
                  </div>
                  <div class="divider-dynamic"></div>
                ...
                <div class="col-md-4 infoblock nopadding">
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-11 col-md-9">
                      ...
                      <p class="">
                        WIP Personal is the simple, clean and stylish fully-responsive resume theme with modern creative design.
                      </p>
                    </div>
                  </div>
                  <div class="divider-dynamic"></div>
            ...
            <div class="padding-50 flex-panel">
              ...
              <div>
                <div class="fullwidth box">
                  ...
                  <div class="two"><p class="">Tony Olagbaiye</p></div>
                </div>
                <div class="fullwidth box">
                  <div class="one"><p class="uppercase text-nowrap">Birth Date:</p></div>
                  <div class="two"><p class="">1996</p></div>
                </div>
                <div class="fullwidth box">
                  <div class="one"><p class="uppercase">Address:</p></div>
                  <div class="two"><p class="">1 Lang House, Lang Avenue, York, United Kingdom</p></div>
                </div>
                <div class="fullwidth box">
                  <div class="one"><p class="uppercase">Phone:</p></div>
                  <div class="two"><p class="">+44 79 448 436 22</p></div>
                </div>
                <div class="fullwidth box">
                  <div class="one"><p class="uppercase">Email:</p></div>
                  <div class="two"><p class="">web@fron.io</p></div>
                </div>
              </div>
        ...
        <div class="row flex-row">
          ...
          <div id="pro-experience" class="col-md-4 flex-column dark nopadding ui-block-color02 flex-col"
            ...
            <div class="padding-50 flex-panel">
              ...
              <a href="resume" class="btn btn-wh-trans btn-xs">Learn More</a>
              <div class="dividewhite1"></div>
            </div>
          </div>
      ...
      <div class="container-fluid nopadding">
        <div class="row">
          ...
          <div class="col-sm-3 cv-link">
            ...
            <a href="#!"><i class="fa fa-long-arrow-down" aria-hidden="true"></i>Italian</a>
            <a href="#!"><i class="fa fa-long-arrow-down" aria-hidden="true"></i>Japanese</a>
            <p class="inline-block">
