...
<head>
   ...
   <title>WIP vCard | Contacts</title>
         ...
         <div class="col-md-8 vc-name nopadding">
            ...
            <div class="row nopadding name">
               ...
               <div class="col-md-2 nopadding name-pdf">
                  <a href="contacts#" class="hvr-sweep-to-right"><i class="flaticon-download149" title="Download CV.pdf"></i></a>
               </div>
            </div>
            <div class="row nopadding position">
               ...
               <div class="col-md-2 nopadding pdf">
                  <a href="contacts#" class="hvr-sweep-to-right"><i class="flaticon-behance7" title="My Behance Portfolio"></i></a>
               </div>
            </div>
            <!-- /Name-Position -->
            ...
            <div class="row">
               ...
               <div class="col-md-6"
                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-10"><p class="small"><a href="contacts#!">//twitter.com/samanderson</a></p></div>
                  </div>
                  <div class="row">
                     <div class="col-sm-2"><span class="font-accident-two-bold uppercase">Facbook:</span></div>
                     <div class="col-sm-10"><p class="small"><a href="contacts#!">//www.facebook.com/samanderson</a></p></div>
                  </div>
                  <div class="row">
                     <div class="col-sm-2"><span class="font-accident-two-bold uppercase">Linkedin:</span></div>
                     <div class="col-sm-10"><p class="small"><a href="contacts#!">//www.linkedin.com/samanderson</a></p></div>
                  </div>
               </div>
            </div>
   ...
   <div class="container-fluid nopadding">
      <div class="row">
         ...
         <div class="col-sm-3 cv-link">
            ...
            <div class="dividewhite1"></div>
            <a href="contacts#!"><i class="fa fa-long-arrow-down" aria-hidden="true"></i>English</a>
            <a href="contacts#!"><i class="fa fa-long-arrow-down" aria-hidden="true"></i>German</a>
            <a href="contacts#!"><i class="fa fa-long-arrow-down" aria-hidden="true"></i>Spanish</a>
            <p class="inline-block">
         ...
         <div class="col-sm-3">
            ...
            <a href="contacts#!" class="btn btn-wh-trans btn-xs">OK</a>
            <div class="divider-dynamic"></div>
         </div>
         <div class="col-sm-3">
            ...
            <div class="follow">
               <ul class="list-inline social">
                  <li><a target="_blank" href="contacts#" class="rst-icon-facebook"><i class="fa fa-facebook"></i></a></li>
                  <li><a target="_blank" href="contacts#" class="rst-icon-twitter"><i class="fa fa-twitter"></i></a></li>
                  <li><a target="_blank" href="contacts#" class="rst-icon-pinterest"><i class="fa fa-pinterest"></i></a></li>
                  <li><a target="_blank" href="contacts#" class="rst-icon-instagram"><i class="fa fa-instagram"></i></a></li>
                  <li><a target="_blank" href="contacts#" class="rst-icon-youtube"><i class="fa fa-youtube"></i></a></li>
               </ul>
            </div>
            <div class="divider-dynamic"></div>
         </div>
